...
function FormNav({onClickPrev, onClickNext, step, onClickSave, onClickPublish, disableNext}) {
  return (
    <div className='form-nav'>
        ...
        {step === 5 && <div className='spread'><Button style={{marginRight: '30px'}} id="draft" onClick={onClickSave} >Save as draft</Button><Button id="active" onClick={onClickPublish}>Publish</Button></div>}
    </div>
  )
}
