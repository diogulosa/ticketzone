...
function Details({children, onChangeDescription, descValue, onChangeURL, valueURL, src, handleImageDrop, handleInputFileClick, handleInputChange, hasError}) {

  return (
    <section className='form-section'>
        <h2 className='heading'>Details</h2>
        <h3>Main image</h3>
        <p className={hasError ? 'error' : 'helper-text'}>This is the first image attendees will see at the top of your listing. Use a high quality image: 2000x1500px (4:3 ratio). JPEG or PNG, no larger than 10MB</p>
